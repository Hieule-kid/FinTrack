 ...
 * the login page so the JVM + Spring context start warming while the user is still typing.
 *
 ...
 * (see {@code SecurityConfig}) so it can be called before authentication.
 *
